...
export class Client {
  ...
  // Layer 1: fetch and parse the manifest.
  fetchManifest(key: string = "index.json"): Promise<Manifest> {
    return loadManifest(this.source, key);
  }
